...
currently:
  learning:    ["Advanced DSA", "System Design", "React Ecosystem"]
  building:    ["Scalable Web Apps", "API Architecture", "Real-time Systems"]
  exploring:   ["Cloud Infrastructure", "WebSockets", "Auth Patterns"]
